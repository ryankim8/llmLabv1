...
A pirate-themed LLM chat REPL powered by Groq. Install with `pip install cmc-csci040-ryankim` and run with the `chat` command.

PyPI: https://pypi.org/project/cmc-csci040-ryankim/